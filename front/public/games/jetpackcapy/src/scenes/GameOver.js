...
export class GameOver extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(this.scale.width / 2, 250, `Score: ${this.score}`, {
        fontSize: "32px",
        fill: "#FFD700",
      })
      .setOrigin(0.5);
    ...
    this.add
      .text(this.scale.width / 2, 450, "Cliquez pour revenir au titre", {
        fontSize: "20px",
        fill: "#87CEEB",
  ...
  resizeBackground() {
    ...
    const coverScale = Math.max(
      this.scale.width / sourceImage.width,
      this.scale.height / sourceImage.height,
    );
